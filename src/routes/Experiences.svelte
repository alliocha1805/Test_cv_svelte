...
<div class="containerTimeline">
    ...
    <div class="timeline-block timeline-block-left">
        <div class="marker"></div>
        <div class="timeline-content">
          <h3>Product Owner Data / API (consultant) - Stelliant</h3>
          <span>Sept 2019 - 2022</span>
          <p>Product Owner de la solution d'EDI du groupe Stelliant (pour le compte de Themis Conseil)</p>
        </div>
    </div>
    ...
    <div class="timeline-block timeline-block-right">
        <div class="marker"></div>
        <div class="timeline-content">
          <h3>Chef de projet Digital / Product Owner Consultant - La Mutuelle Generale</h3>
          <span>2018 - 2019</span>
          <p>
            Product Owner consultant pour le compte de Themis Conseil<br>
            Gestion de projet refonte Espace adhérent / Espace client Entreprise<br>
            Travail sur les flux de données Mutuelle ⇔ Sécurité sociale <br>
            Conseil technico-fonctionnel sur le projet (Site Web et PWA Mobile)<br>
    ...
    <div class="timeline-block timeline-block-left">
        <div class="marker"></div>
        <div class="timeline-content">
          <h3>Consultant Product Owner Themis Conseil</h3>
    ...
    <div class="timeline-block timeline-block-right">
        <div class="marker"></div>
        <div class="timeline-content">
          <h3>Chef de Projet Digital / Product Owner - Infopro Digital</h3>
          <span>2015 - 2018</span>
          <p>
    ...
    <div class="timeline-block timeline-block-left">
        <div class="marker"></div>
        <div class="timeline-content">
          <h3>Chef de Projet Digital - BNP Paribas Cardif</h3>
          <span>2014 - 2014</span>
          <p>
